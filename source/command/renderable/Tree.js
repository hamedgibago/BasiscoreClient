    ...
    RenderAsync(dataSource, context, faces, replaces, dividerRowcount, dividerTemplate, incompleteTemplate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (dataSource.Data.Rows.length != 0) {
                //var relationColumnName = await this.RelationColumnName?.GetValueAsync(context);
                var foreignKey = yield Util.GetValueOrDefaultAsync(this.ForeignKey, context, "parentid");
                var principalKey = yield Util.GetValueOrDefaultAsync(this.PrincipalKey, context, "id");
                var nullValue = yield Util.GetValueOrDefaultAsync(this.NullValue, context, "0");
