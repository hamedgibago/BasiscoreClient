...
class SourceCommand extends CommandBase {
    ...
    LoadDataAsync(sourceName, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var params = {
                'command': this.Element.outerHTML,
                //'params': null,
...
class Member {
    ...
    AddDataSourceAsync(source, sourceSchemaName, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Util.AddToContext(source, context, yield previewTask, yield sortTask, yield postSqlTask);
        });
    }
}
